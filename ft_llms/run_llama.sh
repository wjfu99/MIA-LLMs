...
--block_size 128 --eval_steps 100 --save_epochs 100 --log_steps 100 \
-d ag_news -m decapoda-research/llama-7b-hf --packing --use_dataset_cache \
-e 10 -b 4 -lr 5e-5 --gradient_accumulation_steps 4 \
--train_sta_idx=0 --train_end_idx=10000 --eval_sta_idx=0 --eval_end_idx=1000
...
-e 25 -b 4 -lr 1e-4 --gradient_accumulation_steps 16 \
--train_sta_idx=0 --train_end_idx=10000 --eval_sta_idx=0 --eval_end_idx=1000
...
--block_size 128 --eval_steps 100 --save_epochs 100 --log_steps 100 \
-d wikitext -dc wikitext-103-raw-v1 -m decapoda-research/llama-7b-hf --packing --use_dataset_cache \
-e 25 -b 4 -lr 1e-4 --gradient_accumulation_steps 8 \
--train_sta_idx=10000 --train_end_idx=20000 --eval_sta_idx=1000 --eval_end_idx=2000
...
--block_size 128 --eval_steps 100 --save_epochs 100 --log_steps 100 \
-d wikitext -dc wikitext-103-raw-v1 -m decapoda-research/llama-7b-hf --packing --use_dataset_cache \
-e 25 -b 4 -lr 5e-5 --gradient_accumulation_steps 8 \
--train_sta_idx=0 --train_end_idx=10000 --eval_sta_idx=0 --eval_end_idx=1000